...
{
    public class PRMEntity : BaseEntity
    {
        ...
        public long ProgectAbilityId { get; set; }
        public virtual IdNameEntity ProgectAbility { get; set; }
        public int ProgectYear { get; set; }
        public string GWJL { get; set; }
        public string ProgectExplain { get; set; }
